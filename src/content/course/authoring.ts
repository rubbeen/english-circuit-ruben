...
export function authorLesson(seed: Seed): Lesson {
  ...
  const exercises: Lesson['exercises'] = [
    { id: `${seed.id}-e01`, type: 'multiple-choice', prompt: `¿Qué significa “${a[0]}”?`, options: [a[1], b[1], c[1]], answer: a[1], feedback: `“${a[0]}” significa “${a[1]}”.` },
    { id: `${seed.id}-e02`, type: 'fill', prompt: `Completa con la palabra inglesa para “${b[1]}”.`, options: [], answer: b[0], feedback: `La respuesta es “${b[0]}”.` },
    { id: `${seed.id}-e03`, type: 'match', prompt: `Relaciona “${c[0]}” con su significado.`, options: [c[1], d[1], e[1]], answer: c[1], feedback: `${c[0]} = ${c[1]}.` },
    ...
    { id: `${seed.id}-e05`, type: 'listen-select', prompt: `Escucha “${e[0]}” y elige la traducción.`, options: [e[1], f[1], g[1]], answer: e[1], feedback: `Oíste “${e[0]}”.` },
    ...
    { id: `${seed.id}-e08`, type: 'dialogue-comprehension', prompt: `En el diálogo, ¿qué expresión clave aparece?`, options: [g[0], h[0], a[0]], answer: g[0], feedback: `La expresión usada es “${g[0]}”.` },
  ];
